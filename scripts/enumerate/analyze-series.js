// Analyze series pages from Category:Volumes.
// Paginates the full category, batch-fetches byte sizes, prints histogram.
// Saves raw title+size data to enumerate/output/ for enumerate-series.js to consume.
//
// Usage: node scripts/enumerate/analyze-series.js
...
const SIZES_PATH = `${OUT_DIR}/sizes_series.json`;
...
console.log("Analyzing series from Category:Volumes...\n");
...
// Save as array of [title, bytes] pairs
...
console.log(`  node scripts/enumerate/enumerate-series.js 500`);
